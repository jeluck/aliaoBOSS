...
<!--请在下方写此页面业务相关的脚本-->
<!--  <script type="text/javascript" src="<%=path%>1/boss/static/lib/My97DatePicker/4.8/WdatePicker.js"></script> -->
<!-- <script type="text/javascript" src="<%=path%>1/boss/static/lib/datatables/1.10.0/jquery.dataTables.min.js"></script>  -->
