...
<body>
	<article class="page-container">
		<form action="<%=path%>/rp?a=A-boss-mod&b=fencheng_mod" method="post"
			class="form form-horizontal" id="form-article-add" name="ThisForm">
		
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">一对一视频:</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['reward_percent']}" placeholder="请输入内容" 
						id="changeprice" name="changeprice">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">付费短视频:</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['reward_sv']}" placeholder="请输入内容" 
						id="changeprice1" name="changeprice1">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">礼物:</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['reward_lw']}" placeholder="请输入内容" 
