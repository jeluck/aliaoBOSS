...
<body>
	<article class="page-container">
		<form action="<%=path%>/rp?a=A-boss-mod&b=mod_fenxiao&c=1" method="post"
			class="form form-horizontal" id="form-article-add" name="ThisForm">
		
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">代理比例:</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['agent_fee']}" placeholder="请输入内容" 
