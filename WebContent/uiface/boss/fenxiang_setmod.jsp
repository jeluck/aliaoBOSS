...
<body>
	<article class="page-container">
		<form action="<%=path%>/rp?a=A-boss-search&b=fenxiang_mod" method="post"
			class="form form-horizontal" id="form-article-add" name="ThisForm">
			<div class="row cl">
			   <input type="hidden" value="${pageNo[0]}"  name="myid">
			
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">男:</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['male_percent']}" placeholder="轮播图内容"
						id="changeprice1" name="changeprice1">
				</div>
			</div>
			
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">女:</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['female_percent']}" placeholder="轮播图内容"
