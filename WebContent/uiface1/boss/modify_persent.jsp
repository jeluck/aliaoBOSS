...
<body>
	<article class="page-container">
		<form action="<%=path%>/rp?a=A-boss-mod&b=mod_anchor1" method="post"
			class="form form-horizontal" id="form-article-add" name="ThisForm">
		
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">当前主播提成比例:</label>
	...
	<script type="text/javascript"
		src="<%=path%>/1lib/jquery/1.9.1/jquery.min.js"></script>
