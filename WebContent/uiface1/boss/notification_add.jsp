...
<body>
	<article class="page-container">
		<form action="<%=path%>/rp?a=A-boss-add&b=notification_add" method="post"
			class="form form-horizontal" id="form-article-add" name="ThisForm">
		
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">通知内容:</label>
				<div class="formControls col-xs-8 col-sm-9">
					<textarea  style=" height:100px;resize:none"  class="input-text"
							 placeholder="请输入内容" 
							id="changeprice1" name="changeprice1" ></textarea>
				</div>
			</div>
			<div class="row cl">
