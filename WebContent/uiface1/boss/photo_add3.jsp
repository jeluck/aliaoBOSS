...
<body>
	<article class="page-container">
		<form  action="<%=path%>/rp?a=A-boss-add&b=photo_add" method="post"
			...
			<div class="text-c">
				星级：
						<select id="select1" style="width:120px" class="select1">
							<option value=""></option>
							<option value="1">热门</option>
							<option value="5">活跃</option>
						</select>
						<button type="button" class="btn btn-primary radius" onclick=upimg() name="">
...
function upimg(){
    ...
    if(age == ""){
        layer.msg('请选择星级',{icon:1,time:1000});
        return;
	}
