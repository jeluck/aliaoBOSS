...
<body>
	<article class="page-container">
		<form action="<%=path%>/rp?a=A-boss-mod&b=recharge_mod1" method="post"
		...
		<div class="row cl">
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">M币数量:</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['v_num']}" placeholder="请输入内容" 
						id="num" name="num">
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['price']}" placeholder="请输入内容" 
