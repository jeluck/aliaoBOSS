...
<body>
	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
		     <a href="javascript:;" onclick="proj_edit('添加轮播图','<%=basePath%>/uiface1/boss/photo_add.jsp','600','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加图片</a> 
					...
					<tbody id="list-content">
						<c:forEach var="map" items="${reList}" varStatus="status">
							<tr class="text-c">
								...
								<td>${map['photo_item']}</td>
								<td class="td-manage"><a title="编辑" href="javascript:;"
									onclick="proj_edit('编辑','<%=path%>/rp?p0=A-boss-add&p1=photo2&p2=${map['id']}','600','510')"
