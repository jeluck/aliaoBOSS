...
<body>
	<article class="page-container">
		<form action="<%=path%>/rp?a=A-boss-mod&b=fencheng_mod1" method="post"
			class="form form-horizontal" id="form-article-add" name="ThisForm">
		
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">一级分成比例:</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['first_reward']}" placeholder="请输入内容" 
						id="changeprice" name="changeprice">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">二级分成比例:</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${reList[0]['second_reward']}" placeholder="请输入内容" 
