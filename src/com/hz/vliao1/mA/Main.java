...
public class Main {
    ...
    public static String main(String[] args) throws IOException {//String[] args
        //生成私有参数，不同API需要修改
        Map<String, String> privateParams = generatePrivateParamters(args[3]);
        //生成公共参数，不需要修改
...
//        privateParams.put("Title", "测试图片");
//        privateParams.put("FileName", "221.mp4");
        
//        privateParams.put("Action", "GetVideoPlayAuth");
//        privateParams.put("VideoId", "e3de879be51640478475662eb542da1f");
