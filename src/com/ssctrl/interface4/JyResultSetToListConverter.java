...
public class JyResultSetToListConverter {
	...
	public static ArrayList<Map<String, Object>> ResultSetToList(ResultSet resSet)
			throws SQLException {
		String name="";
		String value="";
		...
		while (resSet.next()) {
			...
			for (int i = 1; i <= columnCount; i++) {
				...
				if(resSet.getObject(i)!=null&&resMetaData.getColumnTypeName(i).equals("DATETIME")||resMetaData.getColumnTypeName(i).equals("TIMESTAMP")){
